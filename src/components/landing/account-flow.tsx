          ...
          {steps.map((step, idx) => {
            ...
            return (
              <div key={idx} className="relative flex flex-col">
                <div className="h-full p-3.5 sm:p-5 lg:p-6 rounded-2xl bg-slate-50 border border-slate-200/90 shadow-sm flex flex-col space-y-2 sm:space-y-3 hover:border-emerald-400 hover:shadow-md transition-all">
