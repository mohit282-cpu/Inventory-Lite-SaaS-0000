      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 bg-white border border-slate-200 shadow-sm rounded-xl p-4 no-print print:hidden">
        ...
        <div className="flex items-center flex-wrap gap-2">
          ...
          <Button
            onClick={handlePrint}
            variant="outline"
            aria-label="Save PDF of tax invoice"
            className="border-slate-300 bg-white hover:bg-slate-50 text-slate-800 font-semibold h-9 px-4 focus-visible:ring-2 focus-visible:ring-indigo-500"
          >
