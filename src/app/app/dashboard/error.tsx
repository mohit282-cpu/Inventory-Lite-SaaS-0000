...
export default function DashboardError({
  ...
  useEffect(() => {
    const id = logger.error('Dashboard error boundary caught error', error, {
      category: 'RUNTIME',
      digest: error.digest,
      path: '/app/dashboard',
    })
    ...
    <div className="p-8 bg-white border border-slate-200 rounded-2xl shadow-xs max-w-lg mx-auto text-center space-y-4 my-8">
      ...
      <div>
        ...
        <p className="text-xs text-slate-600 mt-1">
          A temporary error occurred while fetching your inventory or financial data for the dashboard. Please try reloading this section.
        </p>
      </div>
